"""Source-derived bounded N64 QKV tensor candidate, CPU only.
First prediction is preserved before comparison; normalization order is explicit.
"""
...
SOURCE=V/'nr-vit-qkv-main-20260912/original.ptx';SOURCE_SHA='d9c05b923ffcf28e047adb1d9cda1a958191d7811051dda5feb0172cf9ef9917'
...
def normalize(x):
 """Separate half squares; (8+24)+(0+16); XOR2 thenXOR1; half swap/add."""
 squared=mul(x,x,'square')
 g=add(add(squared[...,8:16],squared[...,24:32],'square pair8+24'),add(squared[...,:8],squared[...,16:24],'square pair0+16'),'four groups')
 ...
 return result,dict(squared=squared,norm2=norm2,clamped_norm2=clamped,inverse_norm=inv)
