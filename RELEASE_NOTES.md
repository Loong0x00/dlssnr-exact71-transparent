...
The 271 MiB compressed archive is split into five numbered release assets:

- `exactnr71-sm120-public-20260915.tar.zst.part-00` through `part-04`;
- `SHA256SUMS.parts` — hashes for every part and the manifest;
...
cat exactnr71-sm120-public-20260915.tar.zst.part-* > exactnr71-sm120-public-20260915.tar.zst
```
