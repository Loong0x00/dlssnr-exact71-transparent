...
def geometry(h,w,x,y):
 if any(type(i)is not int for i in (h,w,x,y)) or not(8<=h<=64 and 8<=w<=64 and h%8==w%8==0 and x in (-4,0) and y in (-4,0)):raise ValueError('admitted positive multiples8 and XY0/-4')
